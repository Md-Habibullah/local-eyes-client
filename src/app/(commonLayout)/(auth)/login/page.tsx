  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-sky-50 to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-950 flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/4 w-40 h-40 bg-linear-to-br from-amber-200/20 to-orange-200/20 dark:from-amber-900/10 dark:to-orange-900/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative w-full max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="flex items-center gap-3 p-3 rounded-xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-white/20 dark:border-gray-700/50">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white">Global Tours</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">1000+ experiences</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-white/20 dark:border-gray-700/50">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white">Expert Guides</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Local professionals</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 p-4 bg-linear-to-r from-blue-100/50 to-sky-100/50 dark:from-blue-900/20 dark:to-sky-900/20 rounded-2xl border border-blue-200/30 dark:border-blue-800/30">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">Travel Blogger</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-2 -left-4 w-20 h-20 bg-linear-to-br from-amber-200/20 to-orange-200/20 dark:from-amber-900/10 dark:to-orange-900/10 rounded-full blur-xl"></div>
          </div>
        </div>
      </div>
    </div>
