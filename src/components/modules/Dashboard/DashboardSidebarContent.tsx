...
const DashboardSidebarContent = ({
  ...
  return (
    <div className="hidden md:flex min-h-screen w-72 flex-col border-r bg-linear-to-b from-gray-900 via-gray-900 to-black">
      {/* Logo Section - Fixed */}
      <div className="relative px-6 py-5 border-b border-gray-800/50 shrink-0">
        ...
        >
          <div className="relative">
            <div className="absolute -inset-1 bg-linear-to-r from-blue-500 to-purple-500 rounded-2xl blur opacity-0 group-hover:opacity-50 transition-opacity duration-500" />
            <div className="relative w-12 h-12 rounded-xl bg-linear-to-br from-gray-900 to-gray-800 border-2 border-gray-800 flex items-center justify-center group-hover:border-blue-500/30 transition-all duration-300">
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-linear-to-r from-blue-900/20 to-purple-900/20 border border-blue-800/20">
      ...
      {/* Scrollable Navigation Area - This now works properly */}
      <ScrollArea className="flex-1 overflow-hidden">
        <div className="h-full flex flex-col">
          <div className="p-4 space-y-2 flex-1">
            {/* Quick Stats Overview */}
            <div className="mb-6 p-4 rounded-xl bg-linear-to-br from-gray-800/40 to-gray-900/40 border border-gray-700/30 backdrop-blur-sm">
              ...
              {navItems.map((section, sectionIdx) => (
                <div key={sectionIdx} className="space-y-2">
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            ...
                            isActive
                              ? "bg-linear-to-r from-blue-900/30 via-blue-900/20 to-purple-900/30 text-white shadow-lg"
                  ...
                  {sectionIdx < navItems.length - 1 && (
                    <Separator className="my-4 bg-linear-to-r from-transparent via-gray-800 to-transparent h-px border-0" />
                  )}
                </div>
              ))}
            </nav>
      ...
      <div className="border-t border-gray-800/50 p-4 bg-linear-to-t from-gray-900 to-transparent shrink-0 mt-auto">
        <div className="flex items-center gap-3 group cursor-pointer p-3 rounded-xl hover:bg-gray-800/30 transition-all">
          {/* Avatar with Status */}
          <div className="relative">
            <div className="relative w-12 h-12 rounded-full bg-linear-to-br from-blue-600 to-purple-600 flex items-center justify-center border-2 border-gray-800">
          ...
          <div className="flex-1 overflow-hidden">
            <div className="flex items-center gap-2">
              <p className="text-sm font-bold text-white truncate">{userData?.profile.name}</p>
              {userInfo.role === 'ADMIN' && (
